...
{ 
    ...
    function getHeader(){
        ...
        <xml> 
         <w:WordDocument> 
          ...
          <w:DrawingGridVerticalSpacing>4.35 pt</w:DrawingGridVerticalSpacing> 
         </w:WordDocument> 
        </xml> 
        ...
        <style> 
            ...
            @page SectionPage 
                ...
                mso-paper-source:0;} 
            div.section1 
                {page:SectionPage; position: fixed;}
            table#hrdftrtbl
            {
    ...
    /** 
     * get Document header and Footer
     * 
     * @return String 
     */ 
    function getHeaderFooter(){

        $header = view('reference-check.header')->render();
     ...
     * @return boolean  
     */ 
    function createDoc($html, $file, $download = false, $mailingAddress){ 
        if(is_file($html)){ 
