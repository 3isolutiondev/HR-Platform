...
return [
    ...
    'backup' => [
        ...
        'source' => [
            ...
            'files' => [
                 ...
                 */
                'include' => [
                    base_path('storage/backup-folder'),
                ],
                ...
                'exclude' => [
                    ...
                    base_path('storage/app/iMMAP-Careers'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('SCRIPT_MAIL_TO', 'developer@organization.org'),
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'careers@organization.org'),
                'name' => env('MAIL_FROM_NAME', 'HR Platform Backup'),
            ],
        ],
