    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'dump' => [
                ...
                'dump_binary_path' => (env('APP_ENV') !== "local") ? '/usr/bin' : '/usr/local/bin', // only the path, so without `mysqldump` or `pg_dump`
                'use_single_transaction',
                'timeout' => 60 * 10, // 5 minute timeout
                'add_extra_option' => '--socket=/opt/bitnami/mysql/tmp/mysql.sock --column-statistics=0 --no-tablespaces',
            ],
        ],
