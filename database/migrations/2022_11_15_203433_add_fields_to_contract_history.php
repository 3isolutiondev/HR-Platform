...
class AddFieldsToContractHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('user_contract_histories', function (Blueprint $table) {
            $table->dropForeign('user_contract_histories_supervisor_id_foreign');
            $table->dropForeign('user_contract_histories_unanet_approver_id_foreign');
            $table->dropForeign('user_contract_histories_cost_center_foreign');
