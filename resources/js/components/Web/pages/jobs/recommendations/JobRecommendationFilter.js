...
import {
	...
	resetFilter,
	genderOnChange
} from '../../../redux/actions/jobs/jobRecommendationFilterActions';

import '../../../common/HR/job.css';
import isEmpty from '../../../validations/common/isEmpty';

class JobRecommendationFilter extends Component {
	constructor(props) {
		super(props);
...
const mapStateToProps = (state) => ({
	jobRecommendationFilter: state.jobRecommendationFilter
});
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(JobRecommendationFilter));
