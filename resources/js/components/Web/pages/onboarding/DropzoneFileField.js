...
import DropzoneFileModal from './DropzoneFileModal';
import DropzoneGallery from '../../common/formFields/dropzoneFile/DropzoneGallery'
		...
		return (
			<FormControl margin={margin} fullWidth={fullWidth} error={!isEmpty(error)}>
				...
				<DropzoneFileModal
					...
					isUpdate={isUpdate}
					getFile={this.props.getFile ? this.props.getFile :''}
