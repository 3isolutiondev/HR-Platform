			...
			columns: [
				...
				},
				{
					...
					options: {
						filter: true,
						sort: true,
						customBodyRender: (value) => moment(value, 'YYYY-MM-DD').year()
					}
				},
				{
					name: 'Action',
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(PublicationLists));
