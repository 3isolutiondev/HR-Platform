...
class EducationUniversity extends Component {
	constructor(props) {
		super(props);
		this.state = {
			openDialog: false,
	...
	render() {
		...
		const { education_universities, education_universities_counts, show } = this.props.educationUniversity;
		const { remove, openDialog, dataId, alertOpen, name } = this.state;
		return (
			<div>
				{show ? (
											...
											return (
												...
												>
													...
													<Grid item xs={12} sm={3}>
														<Typography variant="subtitle2">Degree Level</Typography>
													</Grid>
													<Grid item xs={12} sm={9}>
														<Typography variant="body2">
															{education.degree_level ? education.degree_level.name : ''}
														</Typography>
													</Grid>
													...
													<Grid item xs={12} sm={9}>
														<Typography variant="body2">{education.study}</Typography>
													</Grid>

													<Grid item xs={12} sm={3}>
														<Typography variant="subtitle2">Diploma Certificate</Typography>
													</Grid>
													<Grid container item xs={12} sm={9}>
														{education.diploma_certificate && (
															<Typography variant="body2">
																...
																{education.diploma_certificate.file_name}
															</Typography>
														)}
													</Grid>
												</Grid>
				...
				{editable ? (
					<div>
						...
						<Alert
							...
							text={'Are you sure to delete your university in  ' + name + ' ?'}
							closeText="Cancel"
							AgreeText="Yes"
						/>
					</div>
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(EducationUniversity));
