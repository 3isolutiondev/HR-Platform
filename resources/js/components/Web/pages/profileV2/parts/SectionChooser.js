...
const menu = [
	...
	{ title: 'Areas of Expertise & Others', props: 'bioAddress', name: 'bio_address' },
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(SectionChooser));
