...
class FormEmailUserAnswerReferenceForm extends Component {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
		...
		this.props.getAPI('/api/work-reference/check-exist-data/' + this.props.match.params.profilID).then((res) => {
			if (res.data.data > 0) {
				this.setState({
					hasInput: true
				});
...
FormEmailUserAnswerReferenceForm.propTypes = {
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(FormEmailUserAnswerReferenceForm));
