...
class ReferencecheckForm extends Component {
	...
	addQuestion() {
		...
		this.state.arr_quest.push(this.state.jml);
	}
	...
	handleChange(e) {
		...
		quest[e.target.index][e.target.name] = e.target.value;
			...
			<form onSubmit={this.onSubmit}>
				<Paper className={classes.paper}>
					<Grid container spacing={16}>
						...
						{this.state.arr_quest.length >= 0 ?
							this.state.arr_quest.map((sub_section, index) => {
