import {
	...
	RESET_JOB_RECOMMENDATION_FILTER_DATA,
	RESET_JOB_RECOMMENDATION_PARAMETERS,
...
export default (state = initialState, action = {}) => {
	switch (action.type) {
		case SET_JOB_RECOMMENDATION_FILTER_DATA:
			return {
				...state,
				[action.name]: action.value
			};
		case RESET_JOB_RECOMMENDATION_PARAMETERS:
			return {
				...state,
		...
		case RESET_JOB_RECOMMENDATION_FILTER:
			return {
				...state,
				chosen_sector: [],
				chosen_skill: [],
		...
		case RESET_JOB_RECOMMENDATION_FILTER_DATA:
			return initialState;
		default:
			return state;
	}
