                                ...
                                <tr>
                                    <td class="content-cell">
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $jobUrl }}" class="button button-{{ $color ?? 'primary' }}" target="_blank">{{ $job->title.' Job' }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td styles>
                                                    <p class="sub">If you’re having trouble clicking the {{ $job->title.' Job' }} button, copy and paste the URL below into your web browser: <a href="{{ $jobUrl }}">{{ $jobUrl }}</a></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
