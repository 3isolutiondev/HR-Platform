    ...
    <body>
        ...
        <table style="width: 100%; border-collapse: collapse; border-top: 0;border: 1px solid #043C6E;padding:5px">
            ...
            <tr class="background-th" style="font-weight:bold;padding-top:5px; padding-bottom: 5px;">
                ...
                <td ><div style="font-size: 14px;margin-top:5px;margin-bottom: 5px">{{$interviewUser["user"]->full_name}}</div></td>
            </tr>
        ...
        @foreach($reportData as $key => $report)
            <table style="width: 100%; background-color: #d3bebf; border: 1px solid #043C6E;">
                <tr style="height: 30px;">
                    <td style="width: 90%;font-size:13px;" class="color-red">{{$report["manager"]["manager"]->name}}</td>
